...
class TestCommand(Command):
    ...
    def run(self):
        ...
        unittest.main(module=None, defaultTest='test.GrinderTestCase', argv=test_argv)
...
setup(name="grinder",
      version='0.1.0',
      platforms=['any'],
      description=("Git repository data miner"),
      url='http://github.com/petrh/grinder',
